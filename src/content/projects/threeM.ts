...
export const threeMProject: ProjectData = {
    ...
    thinking:
      '문제를 <span class="font-semibold">서비스 경계</span>와 <span class="font-semibold">인증 컨텍스트 전달</span> 두 레이어로 분리해 비교했습니다.<div class="mt-3 grid gap-3 lg:grid-cols-2"><div class="overflow-x-auto rounded-xl border border-slate-200 dark:border-[#3f3f45]"><div class="bg-slate-100 px-3 py-2 font-bold text-slate-700 dark:bg-[#33333a] dark:text-slate-200">서비스 경계</div><table class="w-full min-w-[520px] table-fixed border-collapse text-left text-sm"><thead class="bg-slate-50 text-slate-500 dark:bg-[#303036] dark:text-slate-400"><tr><th class="w-[27%] px-3 py-2">검토안</th><th class="w-[27%] px-3 py-2">장점</th><th class="w-[31%] px-3 py-2">한계</th><th class="w-[15%] px-3 py-2">판단</th></tr></thead><tbody class="bg-white text-slate-700 dark:bg-[#2f2f34] dark:text-slate-200"><tr class="border-t border-slate-200 dark:border-[#45454d]"><td class="px-3 py-2 font-semibold">책임 혼재</td><td class="px-3 py-2">구현·공유 간단</td><td class="px-3 py-2">정책 변경이 User 배포까지 확산</td><td class="px-3 py-2 font-bold text-red-600 dark:text-red-400">제외</td></tr><tr class="border-t border-blue-200 bg-blue-50/70 dark:border-blue-900/50 dark:bg-blue-950/20"><td class="px-3 py-2 font-bold text-[#2563EB] dark:text-[#8aa8e8]">Auth/User 분리</td><td class="px-3 py-2">변경·배포 경계 분리</td><td class="px-3 py-2">서비스 간 계약 관리 필요</td><td class="px-3 py-2 font-bold text-[#2563EB] dark:text-[#8aa8e8]">선택</td></tr></tbody></table></div><div class="overflow-x-auto rounded-xl border border-slate-200 dark:border-[#3f3f45]"><div class="bg-slate-100 px-3 py-2 font-bold text-slate-700 dark:bg-[#33333a] dark:text-slate-200">인증 컨텍스트 전달</div><table class="w-full min-w-[560px] table-fixed border-collapse text-left text-sm"><thead class="bg-slate-50 text-slate-500 dark:bg-[#303036] dark:text-slate-400"><tr><th class="w-[25%] px-3 py-2">검토안</th><th class="w-[25%] px-3 py-2">장점</th><th class="w-[35%] px-3 py-2">한계</th><th class="w-[15%] px-3 py-2">판단</th></tr></thead><tbody class="bg-white text-slate-700 dark:bg-[#2f2f34] dark:text-slate-200"><tr class="border-t border-slate-200 dark:border-[#45454d]"><td class="px-3 py-2 font-semibold">매 요청 User 재조회</td><td class="px-3 py-2">최신 role 즉시 반영</td><td class="px-3 py-2">호출 증가·User 장애 전파</td><td class="px-3 py-2 font-bold text-red-600 dark:text-red-400">제외</td></tr><tr class="border-t border-slate-200 dark:border-[#45454d]"><td class="px-3 py-2 font-semibold">Gateway 로컬 캐시</td><td class="px-3 py-2">User 호출 감소</td><td class="px-3 py-2">캐시 불일치·무효화 관리</td><td class="px-3 py-2 font-bold text-red-600 dark:text-red-400">제외</td></tr><tr class="border-t border-blue-200 bg-blue-50/70 dark:border-blue-900/50 dark:bg-blue-950/20"><td class="px-3 py-2 font-bold text-[#2563EB] dark:text-[#8aa8e8]">JWT userId·role</td><td class="px-3 py-2">재조회 없이 Gateway 권한 판단</td><td class="px-3 py-2">토큰 만료 전 role 변경 지연</td><td class="px-3 py-2 font-bold text-[#2563EB] dark:text-[#8aa8e8]">선택</td></tr></tbody></table></div></div><div class="mt-3 rounded-lg border border-amber-200 bg-amber-50/80 px-4 py-3 font-semibold leading-relaxed text-amber-800 dark:border-amber-900/40 dark:bg-amber-950/20 dark:text-amber-200">변경 이유가 다른 Auth·User를 분리하고, JWT 컨텍스트로 재조회를 제거해 장애 전파 범위를 줄였습니다.</div>',
    solution:
