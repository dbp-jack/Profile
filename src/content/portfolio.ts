...
export const CLOSING_BLOCKS = [
  ...
  },
  {
    ...
    body:
      '프론트 작업을 생성형 AI로 프롬프트를 설계하고, AI 툴로 구조를 잡고, AI 에이전트로 마무리 작업합니다. 도구를 적극 활용하되, 어떤 구조로 만들지, 왜 이 기술인지, 결과가 의도대로 동작하는지에 대한 판단과 책임은 스스로에게 두고 결정합니다.\n\n팀 안에서도 같은 방식으로 일합니다. JIRA 가이드라인을 직접 설계해 배포한 것도, 스크럼 진행을 맡은 것도 개인 성과보다 팀의 흐름을 맞추는 게 결과물의 질을 높인다는 경험에서 나왔습니다.\n\n도구를 활용하는 것과 도구에 맡기는 것은 다르듯, 협업도 참여하는 것과 흐름을 만드는 것은 다르다고 생각합니다.',
  },
] as const
